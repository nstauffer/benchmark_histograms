...
It may be helpful to compare a single plot to the distribution of a larger set of data. To do this you may select a plot from your input data by selecting the "Compare to Single Plot" check-box and selecting the plot identifier and individual plot you are interested in. If the plot you want to compare is not present in the input data but you know the plot's indicator values you can select the "Compare to a Single Value" check-box and use the slider to adjust the indicator value. In both cases the comparison value will show up in the results window as a violet dashed line.
